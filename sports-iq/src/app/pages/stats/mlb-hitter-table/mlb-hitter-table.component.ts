...
export class MLBHitterTableComponent extends BaseStatsTableComponent {
	...
	constructor() {
		const columns: Column[] = [
			...
			{ name: "WAR", showInFilters: true, isAsc: false, property: "war" },
			{ name: "PA", showInFilters: true, isAsc: false, property: "plateAppearances" },
			...
			{ name: "Base on Balls", showInFilters: true, isAsc: false, property: "baseOnBalls" },
			{ name: "Strikeouts", showInFilters: true, isAsc: false, property: "strikeouts" },
			{ name: "OBP", showInFilters: true, isAsc: false, property: "onBasePercentage" },
			{ name: "Slug", showInFilters: true, isAsc: false, property: "slug" },
			{ name: "OPS+", showInFilters: true, isAsc: false, property: "opsPlus" },
			{ name: "rOBA", showInFilters: true, isAsc: false, property: "roba" }
		];
